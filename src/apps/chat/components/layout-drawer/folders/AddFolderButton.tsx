...
import { getRotatingFolderColor, useFolderStore } from '~/common/stores/folders/store-chat-folders-sqlite';
...
export function AddFolderButton() {
  ...
  const handleCreateFolder = (name: string) => {
    if (name.trim()) useFolderStore.getState().createFolder(name.trim(), newFolderColor || undefined);
